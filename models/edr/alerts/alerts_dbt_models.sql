...
select model_execution_id as alert_id,
       ...
       full_refresh
from error_models
where 'false' = lower('{{ elementary.get_config_var('disable_model_alerts') }}') and lower(status) != 'success' {%- if elementary.get_config_var('disable_skipped_model_alerts') -%} and lower(status) != 'skipped' {%- endif -%}
